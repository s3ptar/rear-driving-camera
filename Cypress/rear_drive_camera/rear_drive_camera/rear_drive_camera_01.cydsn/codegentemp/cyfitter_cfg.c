...
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x480003F8u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000490u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x0022u);
